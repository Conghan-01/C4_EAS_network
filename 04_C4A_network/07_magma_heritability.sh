...
/gpfs/hpc/home/chenchao/hanc/project/C4_CNB2025/01_C4_exp/magma/magma --gene-results /gpfs/hpc/home/chenchao/hanc/project/C4_CNB2025/02_C4_network/downsampling/magma_results/gwas/SCZ_EAS_GeneLevel.genes.raw \
      --set-annot C4A_MAGMA_0.3RGeneSets.txt \
      --out SCZ_Heritability_Results

/gpfs/hpc/home/chenchao/hanc/project/C4_CNB2025/01_C4_exp/magma/magma --gene-results /gpfs/hpc/home/chenchao/hanc/project/C4_CNB2025/02_C4_network/downsampling/magma_results/gwas/BIP_EAS_GeneLevel.genes.raw \
      --set-annot C4A_MAGMA_0.3RGeneSets.txt \
      --out BIP_Heritability_Results
